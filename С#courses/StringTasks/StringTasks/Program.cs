...
namespace StringTasks
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            TextReplacer Replace = new TextReplacer(text1);
            ...
            TextReplacerStatic.ShowShortWordReplacedText(Text);

            TextReplacerStatic.ShowVerbsReplacedText(Text);

            TextReplacerStatic.VerbsCount(Text);

            TextReplacerStatic.ShowVerbsDups(Text);
